...
answer: 3"""
    ...
    def print_summary(self):
        ...
        print("\n" + "="*60)
        print("벤치마크 결과 요약 (GPT-5.1, reasoning: high)")
        print("="*60)
...
def main(limit: int = None, workers: int = 4):
    """메인 실행 함수"""
    ...
    output_file = "result/mcp_benchmark_gpt_5.1_high_result.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MCP RAG Benchmark - GPT-5.1 High")
