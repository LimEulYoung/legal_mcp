...
async def main(limit: int = None, workers: int = 4):
    """메인 실행 함수"""
    ...
    output_file = "result/mcp_benchmark_gemini_2.5_pro_low_guided_result.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MCP RAG Benchmark - Gemini 2.5 Pro Low Guided")
