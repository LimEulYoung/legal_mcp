...
def main(limit: int = None, workers: int = 10):
    ...
    output_file = "result/mcp_benchmark_claude_sonnet_4.5_non_thinking_result.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MCP RAG Benchmark - Claude Sonnet 4.5 Non-Thinking")
