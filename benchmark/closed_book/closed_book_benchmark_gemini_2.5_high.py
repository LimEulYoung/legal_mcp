...
법률 문제 풀이 - 모델 자체 지식만 활용 (Thinking Budget: 32768 - HIGH)
"""
...
class GeminiBenchmarkNoMCP:
    ...
    async def ask_gemini(self, prompt: str) -> Dict:
        """Gemini 2.5 Pro (HIGH thinking)에게 문제 풀이 요청"""
...
answer: 3"""
    ...
    def print_summary(self):
        ...
        print("\n" + "=" * 60)
        print("Closed Book 벤치마크 결과 요약 (Gemini 2.5 Pro HIGH Thinking)")
        print("=" * 60)
...
async def main():
    ...
    parser = argparse.ArgumentParser(description='Closed Book 벤치마크 (Gemini 2.5 Pro HIGH)')
    ...
    print(f"\n{'='*60}")
    print(f"Closed Book 벤치마크 시작 (Gemini 2.5 Pro HIGH)")
    ...
    output_file = "result/closed_book_benchmark_gemini_2.5_high_result.json"
