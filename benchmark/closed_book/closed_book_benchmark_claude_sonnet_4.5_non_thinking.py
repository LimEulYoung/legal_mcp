...
법률 문제 풀이 - 모델 자체 지식만 활용 (Non-thinking 모드)
"""
...
class ClaudeBenchmarkNoMCP:
    ...
    def ask_claude(self, prompt: str) -> Dict:
        """Claude Sonnet 4.5 (non-thinking)에게 문제 풀이 요청"""
...
answer: 3"""
        ...
        # 스트리밍으로 응답 받기 (max_tokens가 클 경우 필요)
    ...
    def print_summary(self):
        ...
        print("\n" + "=" * 60)
        print("Closed Book 벤치마크 결과 요약 (Claude Sonnet 4.5 Non-thinking)")
        print("=" * 60)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Closed Book 벤치마크 (Claude Sonnet 4.5)')
    ...
    print(f"\n{'='*60}")
    print(f"Closed Book 벤치마크 시작 (Claude Sonnet 4.5)")
    ...
    output_file = "result/closed_book_benchmark_claude_sonnet_4.5_non_thinking_result.json"
