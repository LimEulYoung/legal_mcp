...
answer: 3"""
    ...
    def print_summary(self):
        ...
        print("\n" + "="*60)
        print("Closed Book 벤치마크 결과 요약 (GPT-5.1, reasoning: none)")
        print("="*60)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Closed Book 벤치마크 (GPT-5.1, reasoning: none)')
    ...
    print(f"\n{'='*60}")
    print(f"Closed Book 벤치마크 시작 (GPT-5.1, reasoning: none)")
    ...
    output_file = "result/closed_book_benchmark_gpt_5.1_none_result.json"
