...
answer: 3"""
    ...
    def print_summary(self):
        ...
        total_cases = sum(r['cases_retrieved'] for r in self.results)
        total_statutes = sum(r['statutes_retrieved'] for r in self.results)

        # GPT-5.1 가격
        input_cost = (total_input_tokens / 1_000_000) * 2
...
def main():
    ...
    output_file = "result/rag_benchmark_gpt_5.1_medium_result.json"
