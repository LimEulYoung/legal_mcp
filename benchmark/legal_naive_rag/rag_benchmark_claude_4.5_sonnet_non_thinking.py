...
answer: 3"""
    ...
    def print_summary(self):
        ...
        print("\n" + "=" * 60)
        print("RAG 벤치마크 결과 요약 (Claude Sonnet 4.5 Non-thinking)")
        print("=" * 60)
...
def main():
    ...
    output_file = "result/rag_benchmark_claude_4.5_sonnet_non_thinking_result.json"
