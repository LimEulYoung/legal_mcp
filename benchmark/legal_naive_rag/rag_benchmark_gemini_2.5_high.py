#!/usr/bin/env python3
"""
RAG 기반 Gemini 2.5 Pro 벤치마크 스크립트
법률 문제 풀이를 위한 벡터 검색 + LLM 테스트
병렬 처리 지원 (Thinking Budget: 32768 - HIGH)
"""
...
answer: 3"""
    ...
    def print_summary(self):
        ...
        print("\n" + "=" * 60)
        print("RAG 벤치마크 결과 요약 (Gemini 2.5 Pro HIGH Thinking)")
        print("=" * 60)
...
async def main():
    ...
    parser = argparse.ArgumentParser(description='RAG 벤치마크 (Gemini 2.5 Pro HIGH)')
    ...
    THINKING_BUDGET = 32768  # HIGH에 해당
    ...
    output_file = "result/rag_benchmark_gemini_2.5_high_result.json"
