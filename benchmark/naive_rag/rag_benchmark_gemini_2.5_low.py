...
병렬 처리 지원 (Thinking Budget: 128 - LOW)
"""
...
answer: 3"""
    ...
    def print_summary(self):
        ...
        print("\n" + "=" * 60)
        print("RAG 벤치마크 결과 요약 (Gemini 2.5 Pro LOW Thinking)")
        print("=" * 60)
...
async def main():
    ...
    parser = argparse.ArgumentParser(description='RAG 벤치마크 (Gemini 2.5 Pro LOW)')
    ...
    output_file = "result/rag_benchmark_gemini_2.5_low_result.json"
