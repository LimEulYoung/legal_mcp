...
answer: 3"""
    ...
    def print_summary(self):
        ...
        print("\n" + "="*60)
        print("벤치마크 결과 요약 (GPT-5.1, reasoning: low)")
        print("="*60)
...
def main(limit: int = None, workers: int = 3):
    ...
    # 실험 설정
    MODEL_NAME = "gpt-5.1"
    TEMPERATURE = None  # reasoning effort가 none이 아니면 temperature 사용 불가
    MAX_TOKENS = 64000
    REASONING_MODE = "low"
    MAX_WORKERS = workers
    ...
    output_file = "result/mcp_benchmark_gpt_5.1_low_result.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MCP RAG Benchmark - GPT-5.1 Low")
