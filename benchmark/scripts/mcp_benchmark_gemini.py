#!/usr/bin/env python3
"""
통합 Gemini MCP 벤치마크 스크립트
Gemini 2.5 및 3.x 모델을 모두 지원하며, effort 파라미터로 추론 강도를 통일 제어

사용 예시:
  # Gemini 2.5 Pro + high effort
  python mcp_benchmark_gemini.py --model gemini-2.5-pro --effort high --workers 3

  # Gemini 3 Flash + low effort
  python mcp_benchmark_gemini.py --model gemini-3-flash-preview --effort low --workers 3
"""
