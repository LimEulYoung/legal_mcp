#!/usr/bin/env python3
"""
통합 GPT Closed Book 벤치마크 스크립트
GPT 모델을 모두 지원하며, effort 파라미터로 reasoning 강도를 통일 제어

사용 예시:
  # GPT-5.1 + high effort
  python closed_book_benchmark_gpt.py --model gpt-5.1 --effort high --workers 3

  # GPT-5.1 + none effort
  python closed_book_benchmark_gpt.py --model gpt-5.1 --effort none --workers 3
"""
...
def main():
    parser = argparse.ArgumentParser(description="통합 GPT Closed Book 벤치마크")
    ...
    benchmark = GPTClosedBookBenchmark(model=model, effort=effort)
